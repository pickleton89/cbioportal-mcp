...
class APIClient:
    ...
    def __init__(self, base_url: str = "https://www.cbioportal.org/api", client_timeout: float = 480.0):
        ...
        logger.debug(f"APIClient initialized with base_url: {self.base_url}, timeout: {self.client_timeout}")
    ...
    async def shutdown(self):
        ...
        if self._client:
            ...
            logger.info("APIClient's httpx.AsyncClient was already closed or not initialized.")
